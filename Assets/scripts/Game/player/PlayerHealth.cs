...
public class PlayerHealth : MonoBehaviour, IDamageable, IChangingBar
{
    ...
    private void UpdateHP()
    {
        ...
        Debug.Log($"Player level = {PlayerPrefs.GetInt(PlayerPrefsKeys.PlayerLevel)} \n"+
            $"BasicHealth = {_basicHealth}\n" +
            $"FlatModifierTotal = {totalUpgrade.FlatModifierTotal}\n" +
            $"MultipleModifierTotal = {totalUpgrade.MultipleModifierTotal} \n"+
